        ...
        <footer className='navbar'>
            <nav className='navbarNav'>
                <ul className='navbarListItems'>
                    ...
                    <li className='navbarListItem'>
                        <PersonOutlineIcon fill={pathMatchRoute('/userprofile') ? '#2c2c2c' : '#8f8f8f'} width='36px' height='36px' onClick={() => navigate('/userprofile')} />
                        <p className={pathMatchRoute('/userprofile') ? 'navbarListItemNameActive' : 'navbarListItemName'}>
                            Profile
                        </p>
                    </li>
                </ul>
